...
namespace RoutingServeur
{
    internal class selfHosted
    {
        static void Main(string[] args)
        {
            ...
            Uri httpUrl = new Uri("http://localhost:8733/Design_Time_Addresses/RoutingServeur/OrientationLibrary/");

            //Create ServiceHost
            ServiceHost host = new ServiceHost(typeof(OrientationLibrary), httpUrl);
            ...
            host.AddServiceEndpoint(typeof(IOrientationLibrary), binding, "");
