...
namespace ProxyCacheJCDCO
{
    internal class selfHosted
    {
        static void Main(string[] args)
        {
            ...
            Uri httpUrl = new Uri("http://localhost:8733/Design_Time_Addresses/ProxyCacheJCDCO/ProxyCacheService/");
            ...
            Console.WriteLine("Service is host cache at " + DateTime.Now.ToString());
