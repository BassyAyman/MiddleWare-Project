...
public class Step {
    ...
    @XmlElementRef(name = "instruction", namespace = "http://schemas.datacontract.org/2004/07/RoutingServeur", type = JAXBElement.class, required = false)
    protected JAXBElement<String> instruction;
    @XmlElementRef(name = "name", namespace = "http://schemas.datacontract.org/2004/07/RoutingServeur", type = JAXBElement.class, required = false)
    protected JAXBElement<String> name;
    protected Integer type;
    @XmlElementRef(name = "way_points", namespace = "http://schemas.datacontract.org/2004/07/RoutingServeur", type = JAXBElement.class, required = false)
